...
export const MobileTabBar: React.FC<MobileTabBarProps> = ({ activeModule, onNavigate, onOpenChat, onCreateAction }) => {
  ...
  const createOptions = [
    { path: '/create/article', icon: FileText, label: 'Artículo', color: 'text-blue-500', bg: 'bg-blue-500/10' },
    { path: '/create/portfolio', icon: Layers, label: 'Proyecto', color: 'text-amber-500', bg: 'bg-amber-500/10' },
    { path: '/create/course', icon: Video, label: 'Curso', color: 'text-emerald-500', bg: 'bg-emerald-500/10' },
    { path: '/create/asset', icon: Box, label: 'Asset', color: 'text-rose-500', bg: 'bg-rose-500/10' },
    { path: '/create/service', icon: Briefcase, label: 'Servicio', color: 'text-cyan-500', bg: 'bg-cyan-500/10' },
    { path: '/create/service', icon: Building2, label: 'Empleo', color: 'text-indigo-500', bg: 'bg-indigo-500/10' },
    { path: '/create/project', icon: Users, label: 'Equipo', color: 'text-purple-500', bg: 'bg-purple-500/10' },
    { path: '/create/forum', icon: MessageCircleQuestion, label: 'Duda', color: 'text-orange-500', bg: 'bg-orange-500/10' },
    { path: '/create/event', icon: CalendarDays, label: 'Evento', color: 'text-red-500', bg: 'bg-red-500/10' },
  ];
