...
import { Menu, UploadCloud, Bell, Plus, FileText, Layers, Video, Box, Users, Search, Command, Briefcase, MessageCircleQuestion, CalendarDays, Heart, UserPlus, Check, ShoppingCart, Building2, ArrowLeft, X } from 'lucide-react';
      ...
      {isMobileSearchOpen ? (
        <div className="flex w-full items-center gap-3 animate-fade-in">
            <button 
                ...
                className="p-2 -ml-2 text-slate-500 dark:text-slate-400"
            >
            ...
            <div className={`relative flex-1`}>
                <input 
                    ...
                    placeholder="Buscar..." 
                    className={`block w-full pl-4 pr-10 py-2.5 border rounded-xl text-base font-medium bg-slate-100 dark:bg-[#0A0A0C] ${accentBorder} ring-2 ${accentRing} text-slate-900 dark:text-white focus:outline-none`}
                />
                {searchQuery && (
                    <button 
        ...
        <>
          ...
          <div className="flex items-center gap-3 md:gap-5 w-auto md:w-1/3">
