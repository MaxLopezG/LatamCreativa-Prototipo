            ...
            <div className="p-4 pb-2">
                <div className="relative group">
                    ...
                    <input 
                        ...
                        className="w-full bg-slate-100 dark:bg-white/5 border border-transparent focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500/50 rounded-xl py-2.5 pl-10 pr-4 text-sm text-slate-900 dark:text-white outline-none transition-all placeholder-slate-500"
                    />
                </div>
            </div>
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex justify-between items-center mb-1">
                                    <h5 className="font-bold text-slate-900 dark:text-white text-sm truncate group-hover:text-amber-600 dark:group-hover:text-amber-500 transition-colors">{friend.name}</h5>
                            ...
                            {friend.unreadCount && (
                                <div className="h-5 min-w-[20px] px-1.5 rounded-full bg-amber-500 flex items-center justify-center text-[10px] font-bold text-white shadow-sm shadow-amber-500/30">
                                    {friend.unreadCount}
                                </div>
                            )}
                        </button>
                ...
                <div className="relative flex items-center gap-2">
                    ...
                    <div className="relative flex-1">
                        <input 
                            ...
                            className="w-full bg-slate-100 dark:bg-white/5 border border-transparent focus:border-amber-500/50 rounded-full py-2.5 pl-4 pr-12 text-sm text-slate-900 dark:text-white outline-none transition-colors"
                        />
                        <button 
                            onClick={handleSendMessage}
                            className={`absolute right-1 top-1 h-8 w-8 rounded-full flex items-center justify-center transition-all ${
                                inputText.trim() 
                                ? 'bg-amber-500 text-white hover:bg-amber-600 shadow-md transform hover:scale-105' 
